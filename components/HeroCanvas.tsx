...
export default function HeroCanvas() {
  ...
  // Athlete image moves slightly OPPOSITE for depth parallax
  ...
  return (
    <div
      ...
      style={{ position: 'relative', width: '100%', height: '100%', minHeight: 320,
               isolation: 'isolate', overflow: 'hidden', perspective: '1100px' }}
    >
      {/* ── Layer 0: Three.js 3D scene ─────────────────────────── */}
      <HeroScene3D />

      {/* ── Layer 1 + 2: Tilt wrapper (HUD + athlete move together) */}
      <motion.div
        style={{
      ...
      >
        {/* Athlete image (parallax layer — moves opposite to tilt) */}
        <motion.img
