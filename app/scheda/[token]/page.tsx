          ...
          <div className="relative flex-shrink-0">
            <svg width="72" height="72" viewBox="0 0 72 72">
              ...
              <circle cx="36" cy="36" r="30" fill="none"
                stroke="url(#prog-grad-s)" strokeWidth="6"
                strokeLinecap="round"
          ...
          <div>
            ...
            <div className="mb-5 p-3 rounded-xl text-sm flex items-start gap-2"
              ...
              <span>
                ...
                Seleziona la settimana, inserisci il carico (kg) per ogni serie e premi <strong>Salva</strong>. I dati vengono conservati settimana per settimana.
              </span>
            </div>
